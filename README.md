Setup information can be found here: https://tableau.github.io/webdataconnector/docs/

Further information on the contents of the affinity.html and affinity.js files can be found here: https://tableau.github.io/webdataconnector/docs/wdc_tutorial
